      ...
      <div style={styles.content}>
        ...
        {activeTab === "home" && (
          <div>
            ...
            {/* Calendar */}
            <Card>
              <SectionTitle icon="📅" label="Calendario" />
              {calSummary ? (
            ...
            {/* Gmail */}
            <Card>
              <SectionTitle icon="✉" label="Emails importantes" />
              {gmailSummary ? (
            ...
            {/* Tasks preview */}
            <Card>
              <SectionTitle icon="✓" label={`Tareas pendientes`} />
              {pendingCount === 0 ? (
                <p style={{ ...styles.summaryText, color: "#555" }}>Sin tareas pendientes 🎉</p>
              ) : (
        ...
        {activeTab === "tasks" && (
          <div>
            <Card>
              <SectionTitle icon="✓" label="Mis tareas" />
              ...
              {tasks.length === 0 && (
                <p style={{ ...styles.summaryText, color: "#555" }}>Sin tareas. ¡Agregá una!</p>
              )}
              {tasks.map(task => (
        ...
        {activeTab === "chat" && (
          <div>
            <Card style={{ minHeight: 300 }}>
              <SectionTitle icon="◈" label="NEXUS — Asistente" />
